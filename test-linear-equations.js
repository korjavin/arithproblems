...
function testProblemGeneration() {
    const options = { equationType: 'mixed', coefficientRange: 5, solutionRange: 10, allowNegativeSolutions: true, numberOfProblems: 20 };
...
function testEquationTypes() {
    let options = { equationType: 'one-step', coefficientRange: 5, solutionRange: 10, allowNegativeSolutions: false, numberOfProblems: 10 };
    ...
    options = { equationType: 'two-step', coefficientRange: 5, solutionRange: 10, allowNegativeSolutions: false, numberOfProblems: 10 };
    ...
    options = { equationType: 'with-fractions', coefficientRange: 5, solutionRange: 10, allowNegativeSolutions: false, numberOfProblems: 10 };
    data = generateLinearEquationsData(options);
...
function testAllowNegativeSolutions() {
    ...
    let options = { equationType: 'mixed', coefficientRange: 5, solutionRange: 10, allowNegativeSolutions: false, numberOfProblems: 50 };
    let data = generateLinearEquationsData(options);
    ...
    options = { equationType: 'mixed', coefficientRange: 5, solutionRange: 10, allowNegativeSolutions: true, numberOfProblems: 50 };
    data = generateLinearEquationsData(options);
...
function testInputValidation() {
    assert.throws(() => {
        generateLinearEquationsData({ equationType: 'mixed', coefficientRange: 0, solutionRange: 10, allowNegativeSolutions: false, numberOfProblems: 10 });
    }, Error, 'Test Case 6 Failed: Did not throw for coefficientRange < 1.');

    assert.throws(() => {
        generateLinearEquationsData({ equationType: 'mixed', coefficientRange: 11, solutionRange: 10, allowNegativeSolutions: false, numberOfProblems: 10 });
    }, Error, 'Test Case 7 Failed: Did not throw for coefficientRange > 10.');

    assert.throws(() => {
        generateLinearEquationsData({ equationType: 'mixed', coefficientRange: 5, solutionRange: 0, allowNegativeSolutions: false, numberOfProblems: 10 });
    }, Error, 'Test Case 8 Failed: Did not throw for solutionRange < 1.');

    assert.throws(() => {
        generateLinearEquationsData({ equationType: 'mixed', coefficientRange: 5, solutionRange: 51, allowNegativeSolutions: false, numberOfProblems: 10 });
    }, Error, 'Test Case 9 Failed: Did not throw for solutionRange > 50.');

    assert.throws(() => {
        generateLinearEquationsData({ equationType: 'mixed', coefficientRange: 5, solutionRange: 10, allowNegativeSolutions: false, numberOfProblems: 51 });
